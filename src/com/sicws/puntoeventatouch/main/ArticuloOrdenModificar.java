...
public class ArticuloOrdenModificar extends javax.swing.JFrame {
...
//                        txtArticulo.setText(botonFProducto.getText());
           ...
           Logger.getLogger(ArticuloOrdenModificar.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private void initComponents() {
        ...
        btnEliminar2.setBgHover(new java.awt.Color(0, 51, 255));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
       ...
       /* Object [] fila = new Object[8];
        ...
        modelo.setValueAt(txtArticulo.getText(), rowSelected,1);
        modelo.setValueAt(cantidad, rowSelected,2);
        modelo.setValueAt(txtAreaDescripcion.getText(), rowSelected,3);
        modelo.setValueAt(txtAreaExtras.getText(), rowSelected,4);
        modelo.setValueAt(txtPrecio.getText(), rowSelected,5);
        modelo.setValueAt(txtDescuento.getText(), rowSelected,6);
        modelo.setValueAt(txtSubtotal.getText(), rowSelected,7);

                            int lastRow = Ordenes.tablaProductos.convertRowIndexToView(modelo.getRowCount() - 1);
                            Ordenes.tablaProductos.setRowSelectionInterval(lastRow, lastRow);
                            Ordenes.tablaProductos.setColumnSelectionInterval(1, 1);
                            Ordenes.tablaProductos.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticuloOrdenModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArticuloOrdenModificar().setVisible(true);
            }
        });
    }
