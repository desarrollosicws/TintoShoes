...
public class ArticuloVentaModificar extends javax.swing.JFrame {
...
//                        txtArticulo.setText(botonFProducto.getText());
           ...
           Logger.getLogger(ArticuloVentaModificar.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticuloVentaModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArticuloVentaModificar().setVisible(true);
            }
        });
    }
