...
import static com.sicws.puntoeventatouch.main.NuevaVenta.cbxClientes;
import static com.sicws.puntoeventatouch.main.NuevaVenta.idDocumento;
import static com.sicws.puntoeventatouch.main.NuevaVenta.lblTotal;
import static com.sicws.puntoeventatouch.main.NuevaVenta.tablaProductos;
import static com.sicws.puntoeventatouch.main.NuevaVenta.txtAnticipo;
import static com.sicws.puntoeventatouch.main.NuevaVenta.txtImporte;
...
public class Ventas extends javax.swing.JFrame {
    ...
    //ventanaCobros ventana = new ventanaCobros();
...
//                        txtArticulo.setText(botonFProducto.getText());
                        ...
                        String sql = "select precio from precios_articulos where articulo_id = (select articulo_id from articulos where nombre = '"+ValorBoton+"')";
                         ...
                         ArticuloVenta.txtArticulo.setText(String.valueOf(ValorBoton));
                         ArticuloVenta.txtPrecio.setText(String.valueOf(precio));
                         ArticuloVenta.txtDescuento.setText(String.valueOf(Descuento.getDescuento(String.valueOf(ValorBoton),String.valueOf(cbxClientes.getSelectedItem()))));
                         ArticuloVenta.txtCantidad.setText(String.valueOf(1));
                         ArticuloVenta.txtSubtotal.setText(String.valueOf(precio));
                         ArticuloVenta.precioActual = precio;
                         ArticuloVenta.calcularCantidad();
                         art.setVisible(true);
                         //Descuento.getDescuento(Descuento.getDescuento(String.valueOf(ValorBoton),String.valueOf(cbxClientes.getSelectedItem())));
                         System.out.println("DESCUENTO "+Descuento.getDescuento(String.valueOf(ValorBoton),String.valueOf(cbxClientes.getSelectedItem())));
                         try {
                            /*
                             if (servicio) {
...
// lblTotal.setText("0.0");
    ...
    private void initComponents() {
        ...
        btnModificar.setBackground(new java.awt.Color(0, 168, 235));
        btnModificar.setText("MODIFICAR");
        btnModificar.setBgHover(new java.awt.Color(0, 155, 219));
        btnModificar.setBgShade(new java.awt.Color(255, 255, 255));
        btnModificar.setBgShadeHover(new java.awt.Color(255, 255, 255));
        btnModificar.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnModificar.setPixels(0);
        btnModificar.setRound(0);
        ...
        panelVentasLayout.setHorizontalGroup(
            ...
            .addGroup(panelVentasLayout.createSequentialGroup()
                ...
                .addGroup(panelVentasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelVentasLayout.createSequentialGroup()
                        .addComponent(txtArticulo, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//cr.registerComponent(panelLineas);
    ...
    private void btnLiquidarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLiquidarActionPerformed
        finalizarNuevaVenta venta = new finalizarNuevaVenta();
        Double anticipo = Double.parseDouble(txtAnticipo.getText());
        Double importe = Double.parseDouble(txtImporte.getText());
        Double total = Double.parseDouble(lblTotal.getText());
