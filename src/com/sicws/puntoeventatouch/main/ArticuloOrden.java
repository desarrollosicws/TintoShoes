...
import static com.sicws.puntoeventatouch.main.Articulo.txtArticulo;
import static com.sicws.puntoeventatouch.main.Articulo.txtCantidad;
import static com.sicws.puntoeventatouch.main.Articulo.txtPrecio;
import static com.sicws.puntoeventatouch.main.Articulo.txtSubtotal;
import static com.sicws.puntoeventatouch.main.ArticuloVenta.txtAreaDescripcion;
import static com.sicws.puntoeventatouch.main.ArticuloVenta.txtAreaExtras;
import static com.sicws.puntoeventatouch.main.ArticuloVenta.txtArticulo;
import static com.sicws.puntoeventatouch.main.ArticuloVenta.txtDescuento;
import static com.sicws.puntoeventatouch.main.ArticuloVenta.txtPrecio;
import static com.sicws.puntoeventatouch.main.ArticuloVenta.txtSubtotal;
...
public class ArticuloOrden extends javax.swing.JFrame {
...
//                        txtArticulo.setText(botonFProducto.getText());
           ...
           Logger.getLogger(ArticuloOrden.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        DefaultTableModel modelo = (DefaultTableModel) Ordenes.tablaProductos.getModel();
        double cantidad = Double.parseDouble(txtCantidad.getText());
        Object [] fila = new Object[8];
        fila[0] = Ordenes.tablaProductos.getRowCount()+1;
        ...
        modelo.addRow(fila);
        Ordenes.tablaProductos.setModel(modelo);
        System.out.println("NO ES PESABLE");
        int lastRow = tablaProductos.convertRowIndexToView(modelo.getRowCount() - 1);
        tablaProductos.setRowSelectionInterval(lastRow, lastRow);
        tablaProductos.setColumnSelectionInterval(1, 1);
        tablaProductos.requestFocus();
        Ordenes.selectAllAfterCreate();
        Ordenes.calcularTotal();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArticuloOrden.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArticuloOrden().setVisible(true);
            }
        });
    }
