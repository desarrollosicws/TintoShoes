...
public class imprimirTicketVenta {
    public void impresion(Connection cn,String folioVenta){
        try {
            JasperReport report = (JasperReport) JRLoader.loadObject("Venta80mm.jasper");
            HashMap param = new HashMap();
            param.put("Folio", folioVenta);
