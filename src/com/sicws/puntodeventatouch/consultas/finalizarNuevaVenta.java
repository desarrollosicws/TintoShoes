 ...
 * @author ASUS
 */
public class finalizarNuevaVenta {
    ...
    public void liquidarVenta(JLabel lblcambio,JLabel lbltotal,JTextField txtimporte,JTable tabla,JComboBox cbxCliente,JComboBox cbxFormas,JTextField txtAnticipo,int id){
        ...
        try {
            String consultaFolio = "SELECT SERIE,CONSECUTIVO from FOLIOS_CAJAS WHERE TIPO_DOCTO='V' AND CAJA_ID=3297";
        String letra = null;
        int num = 0;
        ...
        fmt.format(letra+"%08d", num);
            ...
            PreparedStatement psInsertFolio = cn.prepareStatement("update folios_cajas set CONSECUTIVO=CONSECUTIVO+1 WHERE CAJA_ID='3297' AND TIPO_DOCTO='V'");
            ...
            Logger.getLogger(finalizarNuevaVenta.class.getName()).log(Level.SEVERE, null, ex);
